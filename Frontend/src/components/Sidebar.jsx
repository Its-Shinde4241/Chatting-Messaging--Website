    ...
    return (
        <aside className="h-full w-16 sm:w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
            ...
            <div className="border-b border-base-300 w-full p-5">
                ...
                {/* todo : online filter tagger */}
                <div className="mt-3 hidden lg:flex items-centerg gap-2">
                        ...
                        >
                            <div className="relative mx-auto lg:mx-0">
                                ...
                                {onlineUsers.includes(user._id) && (
                                    <span
                                        className="absolute border-collapse bottom-0 right-0 size-3 bg-green-500 rounded-full ring-2 ring-zinc-900"
                                    />
                                )}
                            </div>
