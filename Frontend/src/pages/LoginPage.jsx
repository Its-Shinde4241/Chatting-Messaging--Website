                ...
                <div className="w-full max-w-md space-y-8 ">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 group">
                            ...
                            <p className="text-base-content/60">Join Now and Elevate Your Experience. Your Free Account is Just a Click Away!</p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <p className="text-base-content/60">
                            ...
                            <Link to="/signup" className="link-primary hover:underline font-bold">
                                Create account
                            </Link>
                        </p>
                    </div>
